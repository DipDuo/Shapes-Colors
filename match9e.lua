...
function scene:create(event)
	...
	local frameIndexMatch8 = math.random( total_frames )
	if frameIndexMatch == frameIndexMatch8 or frameIndexMatch2 == frameIndexMatch8 or frameIndexMatch3 == frameIndexMatch8 or frameIndexMatch4 == frameIndexMatch8 or frameIndexMatch5 == frameIndexMatch8 or frameIndexMatch6 == frameIndexMatch8 or frameIndexMatch7 == frameIndexMatch8 then
		frameIndexMatch8=frameIndexMatch8+1
	end	

	local frameIndexMatch9 = math.random( total_frames )
	if frameIndexMatch == frameIndexMatch9 or frameIndexMatch2 == frameIndexMatch9 or frameIndexMatch3 == frameIndexMatch9 or frameIndexMatch4 == frameIndexMatch9 or frameIndexMatch5 == frameIndexMatch9 or frameIndexMatch6 == frameIndexMatch9 or frameIndexMatch7 == frameIndexMatch9  or frameIndexMatch8 == frameIndexMatch9 then
		frameIndexMatch9=frameIndexMatch9+1
	end		
	...
	spawnObjMatch8 = display.newImage( sheet, frameIndexMatch8) -- setting 2nd spawnObjMatch to frameIndex # to pass to game
	table.insert (_G.frameIndexes, frameIndexMatch8)            -- insert 2nd indexFrame # to global table (frameIndexes)

		spawnObjMatch8.x = display.contentWidth/2
		spawnObjMatch8.y = display.contentHeight/2+100

	sceneGroup:insert (spawnObjMatch8)

	spawnObjMatch9 = display.newImage( sheet, frameIndexMatch9) -- setting 2nd spawnObjMatch to frameIndex # to pass to game
	table.insert (_G.frameIndexes, frameIndexMatch9)            -- insert 2nd indexFrame # to global table (frameIndexes)

		spawnObjMatch9.x = display.contentWidth/2+100
		spawnObjMatch9.y = display.contentHeight/2+100

	sceneGroup:insert (spawnObjMatch9)
	...
	local function nextScene1 (easyLevel)
       ...
       composer.gotoScene("game9e", options) --the scene/level that tap function transitions to
    end
...
function scene:show( event )
    ...
    if event.phase == "did" then
        composer.removeScene( "game8e" ) -- change string value to reflect game level that was just finished
    end
end
