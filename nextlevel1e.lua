...
----------------------------------------------------------------------------------------------
--Saving function
if myData.settings.easyLevel <= 1 then
	myData.settings.easyLevel = 2
end
----------------------------------------------------------------------------------------------
...
local function handleButtonEvent( event )
    ...
    if ( "ended" == event.phase ) then
        composer.removeScene( "match2e", false )
        composer.gotoScene( "match2e", { effect = "crossFade", time = 333 } )
    end
end
...
function scene:create( event )
    ...
    gameModeText = display.newText("Skill Level: "..myData.settings.currentMode1, display.contentCenterX, display.contentCenterY-40, native.systemFontBold, 30)
