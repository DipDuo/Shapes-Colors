...
----------------------------------------------------------------------------------------------
--Saving function
if myData.settings.medLevel <= 1 then
	myData.settings.medLevel = 2
end
----------------------------------------------------------------------------------------------
...
local function handleButtonEvent( event )
    ...
    if ( "ended" == event.phase ) then
        composer.removeScene( "match2", false )
        composer.gotoScene( "match2", { effect = "crossFade", time = 333 } )
    end
end
...
function scene:create( event )
    ...
    gameModeText = display.newText("Skill Level: "..myData.settings.currentMode2, display.contentCenterX, display.contentCenterY-40, native.systemFontBold, 30)
